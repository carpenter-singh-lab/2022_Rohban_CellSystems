...
The next challenge is to figure out how to get PubChem CID from the Broad ID, because that is what will help us map to the PGC1a screen.

Turns out that is not so simple
https://www.biostars.org/p/249949/
