...
res <- sample.tot(random.shuffle = F, verbose = T, cor.thr = 0.35, how.many = 15)
...
for (i in 1:N) {
  res <- sample.tot(random.shuffle = T, verbose = F, cor.thr = 0.35, how.many = 15)  
  nl <- c(nl, length(res$genes))
  pb$tick()
}
