...
nl <- foreach (i = 1:N) %dopar% {
  res <- sample.tot(Pf.cmpd = Pf.cmpd, Pf.gene = Pf.gene, random.shuffle = F, random.shuffle.genes = T, random.shuffle.cmpds = T, verbose = F, cor.thr = cor.thr, how.many = no.top.matches)
  length(res$genes)
}
