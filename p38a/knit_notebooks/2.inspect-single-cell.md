...
statistics %>%
  ...
  facet_grid(Conc~is_cp_negcon, scales = "free_x", 
...
statistics_agg <-
  ...
  group_by(Cmpd, Conc) %>%
  summarise(across(all_of(
    c("ks_pval", "ks_stat", "t_pval", "t_stat", "median_ratio", "Broad", "is_cp_negcon", "diff5")
  ), mean)) %>%
  ungroup() %>%
...
![](2.inspect-single-cell_files/figure-gfm/unnamed-chunk-31-1.png)<!-- -->
...
![](2.inspect-single-cell_files/figure-gfm/unnamed-chunk-35-2.png)<!-- -->
...
![](2.inspect-single-cell_files/figure-gfm/unnamed-chunk-35-3.png)<!-- -->
...
![](2.inspect-single-cell_files/figure-gfm/unnamed-chunk-35-4.png)<!-- -->
